      ...
      <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-xl shadow">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-400">
            ...
            <Link
              to="/signup"
              className="font-medium text-[#387ED1] hover:text-[#387ED1] hover:text-300 transition duration-150 ease-in-out"
            >
          ...
          <div className="rounded-md shadow-sm -space-y-px ">
            <div>
              ...
              <input
                ...
                autoComplete="email"
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-black rounded-t-md focus:outline-none focus:ring-primary-main focus:border-primary-main focus:z-10 sm:text-sm "
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-black rounded-b-md focus:outline-none focus:ring-primary-main focus:border-primary-main focus:z-10 sm:text-sm "
