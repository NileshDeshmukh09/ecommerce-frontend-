            ...
            <div className="max-w-md w-full space-y-8  p-10 rounded-xl shadow-2xl">
                <div>
                    <div className="flex justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="80" height="80" color="#387ed1" fill="none">
                    ...
                    <h2 className="mt-6 text-center text-3xl font-extrabold text-primary-main">Create your account</h2>
                    <p className="mt-2 text-center text-sm text-gray-400">
                        Already have an account?{' '}
                        <Link to='/login' className="font-medium text-primary-main hover:text-orange-300 transition duration-150 ease-in-out">
                            Login
                        </Link>
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            <input
                                ...
                                name="firstName"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-600 placeholder-gray-500 text-black rounded-t-md focus:outline-none focus:ring-primary-main focus:border-primary-main focus:z-10 sm:text-sm "
                        ...
                        <div>
                            <input
                                type="text"
                                name="lastName"
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-600 placeholder-gray-500 text-black focus:outline-none focus:ring-primary-main focus:primary-main focus:z-10 sm:text-sm "
                        ...
                        <div>
                            <div className="relative">
                                ...
                                <label
                                    htmlFor="userImage"
                                    className="cursor-pointer 0 text-black-200 rounded-b-md py-2 px-3 w-full inline-flex items-center justify-between border border-gray-400  transition duration-300 ease-in-out"
                                >
                    ...
                    <div>
                        <button
                            type="submit"
                            className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-bold rounded-md text-white bg-primary-main  focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-main transition duration-150 ease-in-out"
                        >
                            <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                                <FaArrowRight className="h-5 w-5 text-primary-main group-hover:text-[#2761a8]" aria-hidden="true" />
                            </span>
                            Sign Up
                        </button>
                    </div>
