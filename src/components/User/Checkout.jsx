...
const Checkout = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          const response =  await axios.post(`${import.meta.env.VITE_API_URI}/users/checkout/success`, {
                email: user.email, 
            });
            ...
            alert(`Checkout SuccessFull , Please check your Mail !`)
        ...
        <div className="container mx-auto p-4 bg-gray-100 min-h-screen">
            ...
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6 bg-white shadow-lg rounded-lg p-8">
                ...
                <div className="mt-8">
                    <button
                        type="submit"
                        className="bg-primary-main text-white p-4 rounded-lg hover:bg-orange-700 w-full text-lg font-semibold transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105"
                    >
